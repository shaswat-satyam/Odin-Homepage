function ContactMe() {
  return (
    <>
      <div className="bg-sky-600 px-10 text-4xl py-20">
        <div className="md:flex  md:gap-5 2xl:gap-96 ">
          <div className="text-white md:w-1/2 flex flex-col gap-5">
            <h1 className="text-6xl">Contact Me</h1>
            <p className="text-justify">
              Please contact me if you think our work could be mutally
              benficial!
            </p>
            <p>
              1234 Random Road <br /> Random Town, Califonia 1234
            </p>
          ...
          <img
            ...
            alt=""
            className="md:w-1/2 md:m-0  -mx-10 -my-20 max-w-screen-md w-screen  mt-5"
          />
        </div>
      </div>
    </>
